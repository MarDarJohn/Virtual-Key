...
public class LockedMePrototype {
	...
	public static void main(String[] args) {
		...
		LockedMeDirectoryHandler directoryHandler = new LockedMeDirectoryHandler();
		
		final String defaultDirectory = LockedMeDirectoryHandler.getLocation();

		directoryName = defaultDirectory;
		
		LockedMeFileHandler fileHandler = new LockedMeFileHandler(directoryName);
		...
		System.out.println("*************************************");
		System.out.println("Developer: Marcus Johnson");
